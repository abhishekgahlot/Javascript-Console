    ...
    _consoleObj.reserved_words = ["exit","clear"];
    ...
    var _initiator = function(e){
        if (e.keyCode == 13 && !e.shiftKey){
         ...
         if (e.keyCode == 13){
          if (_consoleObj.console_opened){
            _consoleObj.line += 1;
            if (_consoleObj.line_counter == 0){
              _consoleObj.line+=1
              _consoleObj.line_counter +=1;
            }
          }else{
            _consoleObj.line += 2;
          }
    ...
    //Overriding console.log to return values
      var log = console.log;
