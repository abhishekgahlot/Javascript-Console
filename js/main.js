...
var _history_handler = {
  ...
  move_up: function() {
    ...
    _consoleObj_editor.current()
      .innerText = (typeof _consoleObj._history[_consoleObj._history_index] !== 'undefined') ? _consoleObj._history[_consoleObj._history_index] : '';
...
var _consoleObj_editor = {
  ...
  js_node: function() {
    return '<div id="static-console-2" contenteditable="false"> JS>> </div><div class="editable-console" style="margin-left:39px;" id="' + _consoleObj.editable_consoleObj_name + _consoleObj.count +
      '" contenteditable="true" onkeypress="return _initiator(event)" onkeydown="return _initiator(event)"></div>';
  },

  console_node: function() {
    return '<div id="static-console-2" contenteditable="false">darky@Abhishek-MacBook-Air:~%</div><div class="editable-console" id="' + _consoleObj.editable_consoleObj_name + _consoleObj.count +
      '" contenteditable="true" onkeypress="return _initiator(event)"></div>';
  },
